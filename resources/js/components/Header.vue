...
<template>
    <header class="sticky z-50 px-5 top-2 md:px-20">
        <nav class="flex items-center justify-between px-4 my-2 bg-plata-100 rounded-4xl"
            ...
            <ul :class="[menuAbierto ? 'flex' : 'hidden', 'mx-5 absolute top-full mt-2 min-w-85 flex-col items-center gap-6 rounded-2xl bg-plata-100 py-6 font-medium md:static md:flex md:flex-row md:gap-8 md:mt-0 md:bg-plata-200 md:px-4 md:py-3 inset-x-0']"
