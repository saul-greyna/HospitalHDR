<template>
    <section class="w-full px-5 md:px-20">
        ...
        <div class="grid items-center gap-20 mx-auto md:mt-20 md:w-5/6 lg:grid-cols-2">
            ...
            <div class="space-y-12">
                <div class="p-10 shadow-md bg-sextarian backdrop-blur-sm rounded-3xl">
                    <h2 class="mb-4 text-3xl font-bold text-quinary">Trayectoria</h2>
                ...
                <div class="p-10 shadow-md bg-sextarian backdrop-blur-sm rounded-3xl">
                    <h2 class="mb-4 text-3xl font-semibold text-quinary">Nuestra misión</h2>
                    <p class="leading-relaxed text-quinary">
                ...
                <div class="p-10 shadow-md bg-sextarian rounded-3xl">
                    <h2 class="mb-4 text-3xl font-semibold text-quinary">Nuestra visión</h2>
                    <p class="leading-relaxed text-quinary">
