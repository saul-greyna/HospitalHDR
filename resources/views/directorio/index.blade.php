...
<x-main title="Directorio medico de Hospital Dr. Raúl Hernández" description="Conoce el directorio medico del hopital"
    ...
    <section class="bg-gray-200 md:my-14 rounded-2xl" id="app">
        <header class="flex flex-col items-center md:py-10">
            <p class="mt-6 text-xs font-medium tracking-wide md:text-sm text-quaternary">
                Directorio medico
            </p>
            <h1 class="my-4 text-3xl font-medium text-center md:text-6xl text-quinary">
